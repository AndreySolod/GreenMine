...
- Добавить возможность администратору добавлять новых администраторов. Возможно, реализовать функционал администратора на основе должности;

- В проблемы - добавить поле PoC;

- Проблемы - реализовать в виде карусели, что позволит в красивом виде их отображать;
