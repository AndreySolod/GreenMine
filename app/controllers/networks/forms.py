...
class NetworkForm(FlaskForm):
    ...
    icon_id = Select2IconField(models.NetworkIcon, _l("%(field_name)s:", field_name=models.Network.icon_id.info["label"]), validators=[validators.Optional()], attr_icon="icon_class")
