...
from flask import redirect, abort, url_for, render_template, current_app, flash, request
from flask_babel import lazy_gettext as _l


@bp.route('/authentication/password-policy', methods=["GET", "POST"])
