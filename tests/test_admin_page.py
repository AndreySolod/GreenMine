...
def test_edit_main_parameters(client: FlaskClient):
    edit_main_page_name = client.post(url_for('admin.admin_main_info_edit', _external=False, edit_elem="main_page_name"), data={'main_page_name': "Test main page"})
    ...
    edit_text_main_page = client.post(url_for('admin.admin_main_info_edit', _external=False, edit_elem='text_main_page'), data={'text_main_page': "Test edit text main page"}, follow_redirects=True)
    ...
    main_parameters = client.post(url_for('admin.admin_main_info_edit', _external=False, edit_elem="main_parameters"), data={'default_language': "1", "m2m_join_symbol": "...", "m2m_max_items": 15, "pagination_element_count_select2": 7}, follow_redirects=True)
...
def test_create_issue_by_template(client: FlaskClient):
...
def test_task_template(client: FlaskClient):
    # Index
    index = client.get(url_for('admin.task_template_index', _external=False))
    assert index.status_code == 200, f"Cannot get task template index page. Status_code is {index.status_code}"
    # Create template
    new_show = client.get(url_for("admin.task_template_new", _external=False))
    ...
    new_request = client.post(url_for('admin.task_template_new', _external=False), follow_redirects=True, data=new_template_data)
    ...
    del task
    # Edit template
    get_edit = client.get(url_for("admin.task_template_edit", _external=False, template_id=new_template.id))
    ...
    edit_request = client.post(url_for('admin.task_template_edit', _exernal=False, template_id=new_template.id), follow_redirects=True, data=template_edit_data)
    ...
    for key, value in template_edit_data.items():
        if key == 'task_estimation_time_cost':
            ...
            assert getattr(new_template, key) == value
    # Delete template
    delete_request = client.post(url_for('admin.task_template_delete', template_id=new_template.id, _external=False), follow_redirects=True)
...
def test_project_roles(client: FlaskClient):
    index = client.get(url_for('admin.project_role_index', _external=False))
    assert index.status_code == 200, f"Cannot open index project roles. Status code: {index.status_code}"
    role_new = client.get(url_for("admin.project_role_new", _external=False))
    ...
    create_role = client.post(url_for('admin.project_role_new', _external=False), follow_redirects=True, data=role_data)
    ...
    edit_role_get = client.get(url_for('admin.project_role_edit', role_id=role.id, _external=False))
    ...
    edit_role = client.post(url_for('admin.project_role_edit', role_id=role.id, _external=False), follow_redirects=True, data=role_data)
    ...
    permissions_get = client.get(url_for('admin.project_role_permissions', _external=False))
    assert permissions_get.status_code == 200, 'Cannot open project role permissions page'
    role_delete = client.post(url_for('admin.project_role_delete', _external=False, role_id=role.id), follow_redirects=True)
...
def test_admin_files(client: FlaskClient):
    file_index = client.get(url_for('admin.admin_file_index', _external=False))
    assert file_index.status_code == 200, f"Admin page - cannot open file index page. Status code is {file_index.status_code}"
    file_index_data = client.get(url_for('admin.files_index_data', limit=10, offset=0, search="", _external=False))
    ...
    file_delete = client.post(url_for('admin.files_delete', _external=False, file_id=random_file.id))
...
def test_report_template(client: FlaskClient):
    template_index = client.get(url_for('admin.report_template_index', _external=False))
    assert template_index.status_code == 200, f"Cannot open report template index page. Status code is {template_index.status_code}"
    template_new_get = client.get(url_for('admin.report_template_new', _external=False))
...
def test_project_additional_parameters(client: FlaskClient):
    parameters_index = client.get(url_for('admin.project_additional_parameters_index', _external=False))
    ...
    group_fields = client.get(url_for('admin.project_additional_parameters_index_data', _external=False, group_id=group_id.id, search=""))
    ...
    parameter_new_get = client.get(url_for('admin.project_additional_parameters_new', _external=False))
    ...
    parameter_new = client.post(url_for('admin.project_additional_parameters_new', _external=False), follow_redirects=True, data=parameter_fields)
    ...
    edit_get = client.get(url_for('admin.project_additional_parameters_edit', _external=False, parameter_id=param.id))
    ...
    edit_post = client.post(url_for('admin.project_additional_parameters_edit', parameter_id=param.id, _external=False), follow_redirects=True, data=parameter_fields)
    ...
    for key, value in parameter_fields.items():
        assert getattr(param, key) == value, f"Cannot change project additional field parameter{key}"
    # Delete request
    delete_req = client.post(url_for('admin.project_additional_parameter_delete', parameter_id=param.id, _external=False), follow_redirects=True)
...
def test_credential_template_import(client: FlaskClient):
    # Index template
    index = client.get(url_for('admin.credential_template_index', _external=False))
    assert index.status_code == 200, f"Cannot open credential template index page. Status code is: {index.status_code}"
    # Create template
    new_get = client.get(url_for('admin.credential_template_new', _external=False))
    ...
    new_post = client.post(url_for('admin.credential_template_new', _external=False), follow_redirects=True, data=new_cred_template_data)
    ...
    # Edit template
    edit_get = client.get(url_for('admin.credential_template_edit', _external=False, template_id=cred_template.id))
    ...
    edit_post = client.post(url_for('admin.credential_template_edit', _external=False, template_id=cred_template.id), follow_redirects=True, data=edit_data)
    ...
    # Delete template
    delete_post = client.post(url_for('admin.credential_template_delete', template_id=cred_template.id, _external=False), follow_redirects=True)
...
def test_password_policy(client: FlaskClient):
    page = client.get(url_for('admin.authentication_password_policy_settings', _external=False))
    ...
    policy_post = client.post(url_for('admin.authentication_password_policy_settings', _external=False), follow_redirects=True, data=post_data)
