...
def test_wiki_pages(client: FlaskClient):
    ...
    create_page_get = client.get(url_for('wiki_pages.wikipage_new', _external=False))
    assert create_page_get.status_code == 200, f"Cannot open wiki page create page. Status code is {create_page_get.status_code}"
    create_page_post = client.post(url_for('wiki_pages.wikipage_new', _external=False), data=page_data, follow_redirects=True)
    ...
    ajax_new_page = client.post(url_for('wiki_pages.wikipage_ajax_new', _external=False), data=ajax_page_data)
    ...
    # Edit wiki page
    wiki_page_edit_get = client.get(url_for('wiki_pages.wikipage_edit', _external=False, wikipage_id=another_page.id))
    ...
    wiki_page_edit_post = client.post(url_for('wiki_pages.wikipage_edit', _external=False, wikipage_id=another_page.id), data=post_data, follow_redirects=True)
    ...
    ajax_wiki_page_edit_post = client.post(url_for('wiki_pages.wikipage_ajax_edit', _external=False), data=ajax_edit_data)
    ...
    index_now = client.get(url_for('wiki_pages.pagedirectory_index', _external=False))
    ...
    # Delete wiki page
    ajax_delete = client.post(url_for('wiki_pages.wikipage_ajax_delete', _external=False), data={"page_id": another_page.id}, follow_redirects=True)
    ...
    normal_delete = client.post(url_for('wiki_pages.wikipage_delete', _external=False, wikipage_id=new_page.id), follow_redirects=True)
    ...
    get_wiki_struct = client.get(url_for('wiki_pages.wiki_ajax_struct', _external=False))
