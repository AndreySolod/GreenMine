...
![Лицензия](https://img.shields.io/badge/license-некоммерческая-green)
![Docker](https://img.shields.io/badge/docker-поддерживается-blue)
...
- [GreenMine](#greenmine)
  ...
  - [Быстрый старт](#быстрый-старт)
    - [Использование Docker (рекомендуется)](#использование-docker-рекомендуется)
    - [Ручная установка](#ручная-установка)
  - [Основные преимущества](#основные-преимущества)
  - [Что не реализовано из исходного проекта, что планируется реализовать](#что-не-реализовано-из-исходного-проекта-что-планируется-реализовать)
  - [Установка зависимостей](#установка-зависимостей)
    - [Deb-системы](#deb-системы)
  - [Настройка параметров приложения](#настройка-параметров-приложения)
  - [Основные команды](#основные-команды)
  - [Автоматическое исправление ошибок](#автоматическое-исправление-ошибок)
  - [Логины пользователей](#логины-пользователей)
  - [Запуск в дебаг-режиме](#запуск-в-дебаг-режиме)
...
Заводские учётные данные: admin/admin и worker/worker

### Ручная установка
1. Установите Python 3.8+ и Redis
2. Создайте виртуальное окружение: `python -m venv venv`
3. Активируйте: `source venv/bin/activate`
4. Установите зависимости: `pip install -r requirements.txt`
5. Инициализируйте базу данных: `FLASK_APP=GreenMine flask greenmine db-init`
6. Загрузите значения по умолчанию: `FLASK_APP=GreenMine flask greenmine update-database-value`
7. Запустите (режим разработки): `./GreenMine.py`
...
33. Добавлена возможность отправки уведомлений через WebPush. Сообщения чата могут быть отправлены через эту технологию.
...
GreenMine является полной переработкой [Pentest Collaboration Framework (PCF)](https://gitlab.com/invuls/pentest-projects/pcf).

Особая благодарность:
- Разработчикам оригинального PCF за вдохновение
- Контрибьюторам, которые помогли улучшить GreenMine
- Сообществу open-source за ценные инструменты и библиотеки

## Лицензия

Полный текст лицензии см. в файле `LICENSE.txt`. Для коммерческого использования свяжитесь с автором.